      ...
      <div className=" flex flex-col sm:flex-row items-center sm:items-start p-4 sm:p-6  ">
        ...
        <div className="flex-1 text-center sm:text-left">
          ...
          <button
            ...
            className={`${isInstalled? 'bg-gray-400 text-white font-medium px-5 py-2 rounded-md shadow w-full sm:w-auto cursor-not-allowed': 'bg-green-500 hover:bg-green-600 text-white font-medium px-5 py-2 rounded-md shadow w-full sm:w-auto'}`}
          >
            {/* Install Now ({size}) */}
