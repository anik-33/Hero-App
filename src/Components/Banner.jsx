   ...
   return (
      ...
      <div>
         <div className=' flex flex-col justify-center items-center text-center max-w-screen-xl mx-auto w-full px-4 md:px-8 lg:px-12 py-4 md:py-8 lg:py-12 '>
            ...
            <h1 className='font-bold text-5xl my-4'><span className='bg-gradient-to-r from-[#6a11cb] to-[#2575fc] bg-clip-text text-transparent'>Productive</span> Apps</h1>
            ...
            <div className='mt-5 flex gap-2'>
               <Link to={'https://play.google.com/store/apps/'}><button className='btn bg-white text-black'><img src={playstore} alt="" /> Google Play</button></Link>
               <Link to={'https://www.apple.com/app-store/'}><button className='btn bg-white text-black'><img src={appstore} alt="" /> App Store</button></Link>
            </div>
